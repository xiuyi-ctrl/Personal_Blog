    ...
    <section id="experience" className="py-32">
      <div className="max-w-[1700px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div className="rounded-2xl border border-white/[0.06] bg-gradient-to-br from-white/[0.04] to-white/[0.01] p-8 flex items-center justify-center min-h-[320px] lg:col-span-1">
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-gradient-to-br from-white/[0.04] to-white/[0.01] p-8 md:p-10 flex flex-col justify-center lg:col-span-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {t.experience.stats.map((stat) => (
            <div key={stat.label} className="rounded-2xl border border-white/[0.06] bg-gradient-to-br from-white/[0.04] to-white/[0.01] p-6">
